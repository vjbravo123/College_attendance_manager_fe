    ...
    <>
      ...
      <div className="flex flex-col bg-black pt-20 md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 bg-black text-white flex flex-col justify-center px-6 md:px-16 lg:px-28 py-10">
          <h1 data-aos="fade-right" className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight mb-6">
            Welcome to <br /> Attendance <br /> Management <br /> System
          </h1>

          <p data-aos="fade-up" data-aos-delay="200" className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed mb-8">
          ...
          <div data-aos="zoom-in" data-aos-delay="400" className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <input
              type="email"
        ...
        {/* Right Section */}
        <div data-aos="fade-left" className="w-full md:w-1/2 h-64 md:h-auto">
          <img
          ...
          {features.map((feature, index) => (
            ...
            >
              <img
                ...
                data-aos-delay={200}
              />
              <h3 data-aos="fade-up" data-aos-delay={300} className="text-3xl font-bold text-gray-800 mb-4">
                {feature.title}
              </h3>
              <p data-aos="fade-up" data-aos-delay={400} className="text-xl text-gray-600">{feature.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id='about' className="px-6 py-12 md:px-16 lg:px-24 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h2 data-aos="fade-left" className="text-4xl md:text-5xl font-bold mb-10">
              About Maharaja <br /> Agrasen College
            </h2>
            <p data-aos="fade-up" data-aos-delay="200" className="text-gray-600 leading-relaxed mb-8 md:mb-18 md:mt-18">
            ...
            <div className="grid grid-cols-2 gap-6 text-center">
              <div data-aos="fade-up" data-aos-delay="300">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
                  <CountUp end={1000} duration={1} enableScrollSpy scrollSpyDelay={200} />+
                </h3>
                <p className="text-gray-600 text-sm">Students Enrolled</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="400">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
                  <CountUp end={5000} duration={1} enableScrollSpy scrollSpyDelay={200} />+
                </h3>
                <p className="text-gray-600 text-sm">Total Students</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="500">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
                  <CountUp end={150} duration={1} enableScrollSpy scrollSpyDelay={200} />%
                </h3>
                <p className="text-gray-600 text-sm">Growth in Attendance</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="600">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
                  <CountUp end={1200} duration={1} enableScrollSpy scrollSpyDelay={200} />k
                </h3>
